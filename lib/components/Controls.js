...
var Controls = /** @class */ (function (_super) {
    ...
    Controls.prototype.renderActionButtons = function () {
        var _a = this.props, selection = _a.selection, onFolderCreate = _a.onFolderCreate, onUploadClick = _a.onUploadClick, onDownloadFiles = _a.onDownloadFiles, onViewDetails = _a.onViewDetails, onShare = _a.onShare, onDeleteFiles = _a.onDeleteFiles, getFilesFromSelection = _a.getFilesFromSelection;
